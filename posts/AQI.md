...
In the last section, the same methodologies were replicated for overseas regions, including India, Thailand, and Japan. Within Japan, an ETL pipeline was also implemented to regularily procure and feed Merra2 feature data into our training models and output an animation of predicted PM2.5 for the day.
